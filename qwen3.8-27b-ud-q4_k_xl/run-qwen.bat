...
if not defined LLAMA_SERVER set "LLAMA_SERVER=C:\llama-cpp-src\build-qwen38-90\bin\llama-server.exe"
...
if not defined CTX set "CTX=142456"
...
if not defined LLAMA_QWEN35_MTP_VOCAB set "LLAMA_QWEN35_MTP_VOCAB=128"
if not defined LLAMA_QWEN35_MTP_MAP set "LLAMA_QWEN35_MTP_MAP=%~dp0mtp-tail-token-map.txt"
if not defined SPEC_DRAFT_N_MAX set "SPEC_DRAFT_N_MAX=6"
